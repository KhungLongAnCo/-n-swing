...
// Dinh dang lai hien thi thong tin ngay gio ra man hinh
    ...
    private void btnThem_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThem_ActionPerformed
        ...
        SDT = txtSDT.getText();
        LoaiKhachHang =     main.Main.frmTC.GetCbbSelected(cbbLoaiKhachHang);
...
//              huyphpk00628_asm_gd2.HUYPHPK00628_ASM_GD2.connection.ExcuteQueryUpdateDB(cautruyvan);
           ...
           main.Main.frmTC.layDuLieuKhachHang();
             main.Main.frmTC.SetCbbKhachHangfrm(txtTenKhachHang.getText());
...
public boolean KiemTraNhapKhachHang(int ts) {
        ...
        if (ThongBao.equals("")) {
            ...
            kiemtra = false;
            main.Main.frmTC.ThongBao(ThongBao, "lỗi nhập liệu", 2);
        }
        return kiemtra;
    }
...
int tam=0;
    ...
    private void jPanel_KhachHangComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jPanel_KhachHangComponentShown
        ...
        main.Main.frmTC.layDuLieuKhachHang();
        cbbLoaiKhachHang.setModel(  main.Main.frmTC.LayDuLieucbb("LoaiKhachHang", "TenLoaiKhachHang", "MaLoaiKhachHang"));
        for (int i = 1; i < 32; i++) {
            cbbNgay.addItem(String.valueOf(i));
        }
        for (int i = 1; i < 13; i++) {
