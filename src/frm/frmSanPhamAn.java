...
public class frmSanPhamAn extends javax.swing.JFrame {
    ...
    private void tblSanPham_spaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSanPham_spaMouseClicked
        ...
        main.Main.frmTC.setSelectedCombobox(tblSanPham_spa.getValueAt(viTriDongVuaBam, 3).toString(), cbbMaLoaiSanPham_SanPhamAn);
        main.Main.frmTC.setSelectedCombobox(tblSanPham_spa.getValueAt(viTriDongVuaBam, 6).toString(), cbbHangSanXuat_SanPhamAn);
    ...
    private void jPanelSanPham_spaComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jPanelSanPham_spaComponentShown
       LayDuLieuSanPham("0");
        ...
        cbbMaLoaiSanPham_SanPhamAn.setModel(main.Main.frmTC.LayDuLieucbb("LoaiSanPham", "TenLoaiSanPham", "MaLoaiSanPham"));
        cbbHangSanXuat_SanPhamAn.setModel(main.Main.frmTC.LayDuLieucbb("HangSanXuat", "TenHangSanXuat", "MaHangSanXuat"));
